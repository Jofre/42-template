...
/// ft_strlcpy: returns (dest C-string content, return value), both as `man
/// strlcpy` defines them. The returned content is the bytes up to (not
...
pub fn check() -> usize {
    ...
    // ---- strlcpy hand cases (the return is the length of src, man strlcpy) ----
    ...
    for _ in 0..20000 {
        ...
        // strlcpy: the return is the length of src; the content is a prefix of
        // src that leaves room for the terminator.
