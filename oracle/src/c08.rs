...
//! c-piscine/c-piscine-c-08/tests/ex04/test_strs_to_tab.c drives "zero", "", "a" and
...
fn corners() -> Vec<Vec<Vec<u8>>> {
    ...
    vec![
        ...
        // scan that treats a byte comparing as negative as the end stops at
        // the first of these.
        vec![vec![0xff]],
        vec![vec![0x80]],
...
// c-piscine/c-piscine-c-00/BUILD.bazel reached for ft_print_combn, and acting on it there
