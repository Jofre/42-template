...
# The expected listing, written out: the fixture fixes every name and time, so
# the order and the markers are known before anything runs. Computing it with
# the listing command itself would put the answer in this file.
want='zfile, afile, adir/'
...
# Authoritative full-listing match (plain pass/fail).
