 ...
 * re-terminating. Each dest below is a HEAP buffer with room for exactly the
 * joined string and its terminator, not one byte more (prefilled content plus
 * its terminator, no interior NUL), so any
