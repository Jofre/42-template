...
// to vary — which is why c-piscine/c-piscine-c-00/BUILD.bazel deliberately gives none of
// them a c_diff arm, the same call c-piscine/c-piscine-c-05/BUILD.bazel makes for
...
//     to c-piscine/c-piscine-c-00/tests/ex05/expected.txt, and the other four are
...
/// c-piscine/c-piscine-c-00/BUILD.bazel's own comment named the remedy -- "the cheap and
